          ...
          >
            <div>
              <p className="text-sm text-blue-600">
                Rate: 1 USDB / {order.rate.toFixed(2)} TTD
              </p>
              <p className="text-xl font-bold">{order.amount} USDB</p>
              <p className="text-sm text-gray-600 italic">
                Estimated Cost: ${order.usdb} USDB (for full quantity)
              </p>
            </div>
            <div className="text-right place-content-between flex flex-col justify-between">
              ...
              <div>
                {isMyOrders ? (
                  ...
                  <Link href="/dashboard/sell-usdb/sell">
                  <Button
      ...
      <div className="space-y-6">
        ...
        <div className="md:flex items-center justify-between">
          ...
          <div className="grid grid-cols-2 md:flex space-x-3">
            ...
            <Link href="/dashboard/sell-usdb/create-order">
