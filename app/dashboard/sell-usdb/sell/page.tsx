...
export default function SellUSDB_Form() {
  ...
  const renderBuyForm = () => (
    <div className="space-y-6">
      <h1 className="font-bold text-[#1E64A7]">Sell USDB</h1>
      <Card className="py-2">
        <CardHeader className="px-2 border-b border-[#5995EE29]">
          <CardTitle className="text-base">Sell USDB</CardTitle>
        </CardHeader>
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            <div className="flex gap-2">
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push("/dashboard/sell-usdb")}
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#D9D9D9B2] bg-opacity-30">
        <div className="bg-white rounded-xl p-4 md:w-[500px] shadow-lg text-center relative">
          ...
          <div className="border-t border-b border-[#CACACA] py-6 w-[85%] mx-auto mb-4 flex justify-center">
            <p className="text-sm italic font-400">Your order was accepted and proceeded. <br /> --TTD were credited to your account.</p>
          </div>
        </div>
      </div>    
    );
